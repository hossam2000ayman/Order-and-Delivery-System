...
//variables for database
    ...
    private void initComponents() {
        ...
        jTabbedPane5.addTab("Check-In", jTabbedPane6);
        ...
        jTabbedPane5.addTab("Check-Out", jTabbedPane7);
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(emailaddresstext, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(nationalidtext, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTabbedPane5, javax.swing.GroupLayout.DEFAULT_SIZE, 324, Short.MAX_VALUE)
        );
...
//        // TODO add your handling code here:
//        if(!(NationalID_Check_In.getText().equals("") && Passwordtext_Check_IN.getText().equals(""))){
////                dispose();
////            //if(correct password){
////            Adminstratour_Job AJ = new Adminstratour_Job();
////            Adminstratour_Job.AddRowToJTable2(new Object []{"","","","","",NationalID_Check_In.getText(),"System User"});
////                AJ.show();
...
//        }
    ...
    private void jbtn_CheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_CheckOutActionPerformed
        // TODO add your handling code here:
//
//        if(!(NationalIDtext_Check_Out.getText().equals("") && Passwordtext_Check_IN.getText().equals(""))){
//                dispose();
//            //if(correct password){
//            Adminstratour_Job AJ = new Adminstratour_Job();
//            Adminstratour_Job.AddRowToJTable2(new Object []{"","","","","",NationalIDtext_Check_Out.getText(),"System User"});
//                AJ.show();
//                AJ.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
//                
...
//            }
//            if (!nationalidtext.getText().equals("") && !firstnametext.getText().equals("") && !lastnametext.getText().equals("") && !emailaddresstext.getText().equals("") && !phonenumbertext.getText().equals("") && !passwordtext.getText().equals("") && !confirmpasswordtext.getText().equals("")) {
//                Adminstratour_Job.AddRowToJTable(new Object[]{"", firstnametext.getText(), lastnametext.getText(), emailaddresstext.getText(), phonenumbertext.getText(), nationalidtext.getText(), "System User", "", "", ""});
//                JOptionPane.showMessageDialog(this, "Registeration Saved");
//                nationalidtext.setBackground(Color.white);
//                firstnametext.setBackground(Color.white);
//                lastnametext.setBackground(Color.white);
//                emailaddresstext.setBackground(Color.white);
...
//        String firstname, lastname, email_address, address, phonenumber, nationalid, password, confirm_password;
//        firstname = firstnametext.getText().toString();
//        lastname = lastnametext.getText().toString();
//        email_address = emailaddresstext.getText().toString();
//        address = addresstext.getText().toString();
//        phonenumber = phonenumbertext.getText().toString();
//        nationalid = nationalidtext.getText().toString();
//        password = passwordtext.getText().toString();
//        //step 1 you need a driver
...
//            String query = "SELECT * FROM System_User_Form WHERE firstname='" + firstname + "' "
//                    + "and lastname='" + lastname + "' " + "and email_address='" + email_address + "' "
//                    + "and address='" + address + "' " + "and phonenumber='" + phonenumber + "' "
//                    + "and nationalid='" + nationalid + "' " + "and password='" + password + "' ";
...
//
//            if (rs.next()) {
//                national = rs.getString("nationalid");
//                fname = rs.getString("firstname");//as  in database
